...
st.markdown(f"И выполнено <b><i><mark>какое-либо</mark></i></b> из условий: <b>систематические тренировки для достижения результата, призовые места на соревнованиях, спортивный разряд</b>...<br />Если этих условий нет, можете оставить секцию пустой.", unsafe_allow_html=True)
