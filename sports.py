...
sports = ['Футбол', 'Баскетбол', 'Волейбол', 'Гандбол', 'Хоккей', 'Фигурное катание', 'Конькобежный спорт', 'Лыжные гонки', 'Биатлон', 'Горнолыжный спорт', 'Фристайл на роликовых коньках', 'Бег на короткие дистанции', 'Бег на длинные дистанции', 'Лёгкая атлетика многоборье', 'Спортивное ориентирование', 'Спортивная гимнастика', 'Художественная гимнастика', 'Спортивная аэробика', 'Плавание', 'Гребля на байдарках', 'Парусный спорт', 'Велоспорт', 'Большой теннис', 'Настольный теннис', 'Бадминтон', 'Дартс', 'Гольф', 'Шахматы', 'Шашки', 'Гиревой спорт', 'Пауэрлифтинг', 'Тяжёлая атлетика', 'Вольная борьба', 'Греко-римская борьба', 'Дзю-до', 'Каратэ', 'Самбо', 'Бокс', 'Таэквондо', 'MMA', 'Стрельба из винтовки', 'Стрельба из пистолета', 'Стрельба из лука', 'Фехтование']
